                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <form action="<?php echo base_url("products/image_upload/$product->id") ?>" id="dropzone" class="dropzone" data-plugin="dropzone"
                                    data-options="{ url: '<?php echo base_url("products/image_upload/$product->id") ?>'}">
            ...
            <section class="app-content">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <header class="widget-header">
                                <h4 class="widget-title pull-left">Ürünün Fotoğrafları</h4>
                                    ...
                                    <table id="default-datatable" data-plugin="DataTable" class="table table-bordered table-striped table-hover"
                                        ...
                                        <tbody>
                                            <?php foreach($product_images as $pi){ ?>
                                                <?php if($product->id == $pi->product_id){ ?>
                                                    <tr>
                                                        <td><?php echo $pi->id ?></td>
                                                        <td><?php echo $pi->img_url ?></td>
                                                        <td>
                                                            <img src="<?php echo base_url("uploads/products/$pi->img_url") ?>" alt="<?php echo $pi->img_url ?>" height="100" width="100">
                                                        </td>
                                                        <td>
                                                            <input 
                                                                data-url="<?php echo base_url("products/isCoverSetter/$pi->id/$pi->product_id") ?>"
                                                                class="is-cover"
                                                                id="switch-2-2" 
                                                                type="checkbox" 
                                                        ...
                                                        <?php $table = "product_images"; ?>
                                                        <td>
                                                            <input 
                                                                data-url="<?php echo base_url("products/isActiveSetter/$pi->id/$table") ?>"
                                                                class="is-active"
                                                                id="switch-2-2" 
                                                                type="checkbox" 
                                                        ...
                                                        <td>
                                                            <button 
                                                            data-url="<?php echo base_url("products/delete/$pi->id/$table") ?>" 
